    ...
    <div className="w-full max-w-sm">
      <div className="text-center mb-4">
        <div className="flex flex-col items-center mb-4">
          <svg preserveAspectRatio="xMidYMid meet" viewBox="8.36 17.58 283.3 237.13" xmlns="http://www.w3.org/2000/svg" className="h-12 w-auto" fill="#18181b" aria-label="ProjectEM">
            <g>
          ...
          <span className="text-zinc-900 font-semibold text-[7px] tracking-[0.2em] uppercase">Projectem</span>
        </div>
